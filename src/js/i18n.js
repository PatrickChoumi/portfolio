...
const DICT = {
  fr: {
    ...
    'block.facts': 'Fiche',
    'exp.title': 'Parcours',
    'exp.lede': 'Le plus récent en premier. Chaque étape est un commit ; les lignes marquées sont ce qui a été appris.',
    'stack.title': 'Stack',
    'stack.lede': 'Ce que j’utilise, et ce que j’en sais. Le C d’abord, le reste par-dessus.',
    'projects.title': 'Projets',
    'projects.lede': 'Quatre choses à construire cette année, décrites par ce qu’elles résolvent plutôt que par la liste des technologies employées.',
    ...
    'portrait.flip': 'Cliquer pour le voir en caractères.',
    'term.hint': 'tape « help »',
    ...
    'aria.palette': 'Rechercher',
    'aria.term': 'Ouvrir le terminal',
  ...
  en: {
    ...
    'exp.title': 'Career',
    'exp.lede': 'Most recent first. Every step is a commit; the marked lines are what was learned.',
    'stack.title': 'Stack',
    'stack.lede': 'What I use, and what I know of it. C first, the rest on top.',
    'projects.title': 'Projects',
    'projects.lede': 'Four things to build this year, described by what they solve rather than by the list of technologies involved.',
    ...
    'portrait.flip': 'Click to see it as characters.',
    'term.hint': 'type “help”',
