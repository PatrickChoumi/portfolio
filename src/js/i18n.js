...
const DICT = {
  fr: {
    ...
    'block.facts': 'Fiche',
    'exp.title': 'Parcours',
    'exp.lede': 'Le plus récent en premier. Chaque poste est un commit ; les lignes marquées sont ce qui a réellement changé.',
    'stack.title': 'Stack',
    'stack.lede': 'Une liste, pas un palmarès. Des jauges donneraient une fausse précision : personne ne sait ce que « quatre sur cinq » veut dire.',
  ...
  en: {
    ...
    'exp.title': 'Career',
    'exp.lede': 'Most recent first. Every role is a commit; the marked lines are what actually changed.',
    'stack.title': 'Stack',
    'stack.lede': 'A list, not a leaderboard. Gauges would imply a precision nobody has: no one knows what “four out of five” means.',
