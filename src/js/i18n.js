...
const DICT = {
  fr: {
    ...
    'block.facts': 'Fiche',
    'exp.title': 'Parcours',
    'exp.lede': 'Le plus récent en premier. Chaque poste est un commit ; les lignes vertes sont ce qui a réellement changé.',
    'stack.title': 'Stack',
    'stack.lede': 'Une jauge pleine veut dire « je peux déboguer ça un dimanche soir, en production ». Le reste est honnête aussi.',
  ...
  en: {
    ...
    'exp.title': 'Career',
    'exp.lede': 'Most recent first. Every role is a commit; the green lines are what actually changed.',
    'stack.title': 'Stack',
    'stack.lede': 'A full gauge means “I can debug this on a Sunday night, in production”. The rest is honest too.',
