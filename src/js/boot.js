...
// Compté, pas écrit à la main : une commande ajoutée ne doit pas laisser le
// log de démarrage annoncer un chiffre faux.
const NB_COMMANDS = Object.values(COMMANDS).filter((c) => !c.hidden).length;
...
const LINES = {
  fr: [
    ...
    ['ok', 'profil monté sur /'],
    ['ok', 'thème détecté'],
    ['ok', `shell prêt — ${NB_COMMANDS} commandes`],
  ...
  en: [
    ...
    ['ok', 'theme detected'],
    ['ok', `shell ready — ${NB_COMMANDS} commands`],
